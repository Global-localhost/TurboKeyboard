...
package com.phonemetra.turbo.keyboard.latin.common;
...
public final class Constants {
	...
	public static final class ImeOption {
		 ...
		 * search dialog when the dialog is already showing a voice search
		 * button.
		 */
		...
		/**
		 * The private IME option used to indicate that no settings key should
		 * be shown for a given text field.
		 */
		public static final String NO_SETTINGS_KEY = "noSettingsKey";
		
		/**
		 * The private IME option used to indicate that the given text field
		 * needs ASCII code points input.
		 */
		public static final String FORCE_ASCII = "forceAscii";
		
		/**
		 * The private IME option used to suppress the floating gesture preview
		 * for a given text field. This overrides the corresponding keyboard
		 * settings preference.
		 * {@link com.phonemetra.turbo.keyboard.latin.settings.SettingsValues#mGestureFloatingPreviewTextEnabled}
		 */
	...
	public static final class Subtype {
		...
		public static final class ExtraValue {
			/**
			 * The subtype extra value used to indicate that this subtype is
			 * capable of entering ASCII characters.
			 */
			public static final String ASCII_CAPABLE = "AsciiCapable";

			/**
			 * The subtype extra value used to indicate that this subtype is
			 * enabled when the default subtype is not marked as ascii capable.
			 */
			public static final String ENABLED_WHEN_DEFAULT_IS_NOT_ASCII_CAPABLE = "EnabledWhenDefaultIsNotAsciiCapable";

			/**
			 * The subtype extra value used to indicate that this subtype is
			 * capable of entering emoji characters.
			 */
			public static final String EMOJI_CAPABLE = "EmojiCapable";

			/**
			 * The subtype extra value used to indicate that this subtype
			 * requires a network connection to work.
			 */
			public static final String REQ_NETWORK_CONNECTIVITY = "requireNetworkConnectivity";

			/**
			 * The subtype extra value used to indicate that the display name of
			 * this subtype contains a "%s" for printf-like replacement and it
			 * should be replaced by this extra value. This extra value is
			 * supported on JellyBean and later.
			 */
			public static final String UNTRANSLATABLE_STRING_IN_SUBTYPE_NAME = "UntranslatableReplacementStringInSubtypeName";

			/**
			 * The subtype extra value used to indicate this subtype keyboard
			 * layout set name. This extra value is private to LatinIME.
			 */
			public static final String KEYBOARD_LAYOUT_SET = "KeyboardLayoutSet";

			/**
			 * The subtype extra value used to indicate that this subtype is an
			 * additional subtype that the user defined. This extra value is
			 * private to LatinIME.
			 */
	...
	public static final class TextUtils {
		/**
		 * Capitalization mode for {@link android.text.TextUtils#getCapsMode}:
		 * don't capitalize characters. This value may be used with
		 ...
		 */
		// TODO: Straighten this out. It's bizarre to have to use
		// android.text.TextUtils.CAP_MODE_*
	...
	// A hint on how many characters to cache from the TextView. A good value of
	// this is given by
	// how many characters we need to be able to almost always find the caps
	// mode.
	public static final int EDITOR_CONTENTS_CACHE_SIZE = 1024;
	// How many characters we accept for the recapitalization functionality.
	// This needs to be
	// large enough for all reasonable purposes, but avoid purposeful attacks.
	// 100k sounds about
	// right for this.
	 ...
	 * {@link com.phonemetra.turbo.keyboard.KeyboardActionListener#onCustomRequest(int)}
	 * .
	 */
	...
	/**
	 * Special keys code. Must be negative. These should be aligned with
	 * constants in
	 * {@link com.phonemetra.turbo.keyboard.internal.KeyboardCodesSet}.
	 */
	...
	public static String printableCode(final int code) {
		...
		default:
			if (code < CODE_SPACE)
				return String.format("\\u%02X", code);
			if (code < 0x100)
	 ...
	 * {@link com.phonemetra.turbo.keyboard.R.integer#config_screen_metrics}.
	 */
	...
	/**
	 * Default capacity of gesture points container. This constant is used by
	 * {@link com.phonemetra.turbo.keyboard.internal.BatchInputArbiter} and etc.
	 * to preallocate regions that contain gesture event points.
	 */
